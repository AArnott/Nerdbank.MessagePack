...
[NBMsgPack010](NBMsgPack010.md) | Usage | Error | `[DerivedTypeShapeAttribute]` should specify an assignable type
[NBMsgPack011](NBMsgPack011.md) | Usage | Error | `[DerivedTypeShapeAttribute]` alias must be unique
[NBMsgPack012](NBMsgPack012.md) | Usage | Error | `[DerivedTypeShapeAttribute]` type must be unique
