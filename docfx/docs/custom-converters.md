...
Custom converters are encouraged to implement @Nerdbank.MessagePack.IMessagePackConverterJsonSchemaProvider to support the @Nerdbank.MessagePack.MessagePackSerializer.GetJsonSchema* methods.
