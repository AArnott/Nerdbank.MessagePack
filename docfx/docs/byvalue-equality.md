...
Even when types override these methods, they are often not implemented for *deep* by-value comparison.
...
Collision resistant hashing functions can be produced by calling @Nerdbank.MessagePack.ByValueEqualityComparer.GetHashResistant* instead of @Nerdbank.MessagePack.ByValueEqualityComparer.GetDefault*, as described in [our topic on hash collisions](security.md#hash-collisions).
