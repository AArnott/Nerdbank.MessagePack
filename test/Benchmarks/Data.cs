...
internal static class Data
{
	internal static class PocoMapInit
	{
		...
		internal static readonly byte[] SingleMsgpackArray = MsgPackCSharp.MessagePackSerializer.Serialize(Single, MsgPackCSharp.MessagePackSerializerOptions.Standard);
		internal static readonly ReadOnlySequence<byte> SingleMsgpack = new(SingleMsgpackArray);
