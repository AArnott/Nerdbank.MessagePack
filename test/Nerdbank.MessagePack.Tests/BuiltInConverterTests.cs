...
public partial class BuiltInConverterTests : MessagePackSerializerTestBase
{
	...
	public static OptionalConverters.GuidStringFormat[] GuidStringFormats =>
	[
		OptionalConverters.GuidStringFormat.StringD,
		OptionalConverters.GuidStringFormat.StringN,
		OptionalConverters.GuidStringFormat.StringB,
		OptionalConverters.GuidStringFormat.StringP,
		OptionalConverters.GuidStringFormat.StringX,
	];
	...
	[Theory, PairwiseData]
	public void Guid_ParseAnyStringFormat([CombinatorialMemberData(nameof(GuidStringFormats))] OptionalConverters.GuidStringFormat format, bool uppercase)
	{
	...
	[Theory, PairwiseData]
	public void Guid_TruncatedInputs([CombinatorialMemberData(nameof(GuidStringFormats))] OptionalConverters.GuidStringFormat format)
	{
		this.Serializer = this.Serializer.WithGuidConverter(format);
	...
	[Theory, PairwiseData]
	public void Guid_MissingHexCharacter([CombinatorialMemberData(nameof(GuidStringFormats))] OptionalConverters.GuidStringFormat format)
	{
		this.Serializer = this.Serializer.WithGuidConverter(format);
