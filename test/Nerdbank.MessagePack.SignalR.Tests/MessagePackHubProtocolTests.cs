...
public partial class MessagePackHubProtocolTests
{
	...
	{
		this.protocol = new MessagePackHubProtocol(Witness.ShapeProvider);
	}

	[Fact]
	public void Constructor_CreatesInstance()
	{
		var protocol = new MessagePackHubProtocol(Witness.ShapeProvider);
	...
	public void Constructor_WithSerializer_CreatesInstance()
	{
		...
		var protocol = new MessagePackHubProtocol(Witness.ShapeProvider, serializer);
