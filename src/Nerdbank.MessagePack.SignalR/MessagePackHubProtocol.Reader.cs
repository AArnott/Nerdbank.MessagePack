...
public partial class MessagePackHubProtocol
{
	...
	private object?[] BindArguments(ref MessagePackReader reader, IInvocationBinder binder, string target)
	{
		...
		{
			throw new MessagePackSerializationException($"Argument count mismatch. Expected {parameterTypes.Count}, got {argumentCount}.");
		}
