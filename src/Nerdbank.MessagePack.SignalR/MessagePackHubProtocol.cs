...
/// </remarks>
public partial class MessagePackHubProtocol : IHubProtocol
{
	...
	public MessagePackHubProtocol(ITypeShapeProvider typeShapeProvider, MessagePackSerializer serializer)
	{
		this.userTypeShapeProvider = typeShapeProvider ?? throw new ArgumentNullException(nameof(typeShapeProvider));
		this.userSerializer = serializer ?? throw new ArgumentNullException(nameof(serializer));
	}
