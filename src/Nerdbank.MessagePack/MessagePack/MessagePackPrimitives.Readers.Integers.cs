...
partial class MessagePackPrimitives
{
	...
	public static DecodeResult TryRead(ReadOnlySpan<byte> source, out Byte value, out int tokenSize)
	{
		if (source.Length > 0)
		{
	...
	/// <returns>The value.</returns>
	/// <exception cref="OverflowException">Thrown when the value exceeds what can be stored in the returned type.</exception>
	public static DecodeResult TryRead(ReadOnlySpan<byte> source, out UInt16 value, out int tokenSize)
	{
		if (source.Length > 0)
		{
			DecodeResult result = Decoders.UInt64JumpTable[source[0]].Read(source, out ulong longValue, out tokenSize);
	...
	/// <returns>The value.</returns>
	/// <exception cref="OverflowException">Thrown when the value exceeds what can be stored in the returned type.</exception>
	public static DecodeResult TryRead(ReadOnlySpan<byte> source, out UInt32 value, out int tokenSize)
	{
		if (source.Length > 0)
		{
			DecodeResult result = Decoders.UInt64JumpTable[source[0]].Read(source, out ulong longValue, out tokenSize);
	...
	/// <returns>The value.</returns>
	/// <exception cref="OverflowException">Thrown when the value exceeds what can be stored in the returned type.</exception>
	public static DecodeResult TryRead(ReadOnlySpan<byte> source, out UInt64 value, out int tokenSize)
	{
		if (source.Length > 0)
		{
			DecodeResult result = Decoders.UInt64JumpTable[source[0]].Read(source, out ulong longValue, out tokenSize);
	...
	/// <returns>The value.</returns>
	/// <exception cref="OverflowException">Thrown when the value exceeds what can be stored in the returned type.</exception>
	public static DecodeResult TryRead(ReadOnlySpan<byte> source, out SByte value, out int tokenSize)
	{
		if (source.Length > 0)
		{
	...
	/// <returns>The value.</returns>
	/// <exception cref="OverflowException">Thrown when the value exceeds what can be stored in the returned type.</exception>
	public static DecodeResult TryRead(ReadOnlySpan<byte> source, out Int16 value, out int tokenSize)
	{
		if (source.Length > 0)
		{
			DecodeResult result = Decoders.Int64JumpTable[source[0]].Read(source, out long longValue, out tokenSize);
	...
	/// <returns>The value.</returns>
	/// <exception cref="OverflowException">Thrown when the value exceeds what can be stored in the returned type.</exception>
	public static DecodeResult TryRead(ReadOnlySpan<byte> source, out Int32 value, out int tokenSize)
	{
		if (source.Length > 0)
		{
			DecodeResult result = Decoders.Int64JumpTable[source[0]].Read(source, out long longValue, out tokenSize);
	...
	/// <returns>The value.</returns>
	/// <exception cref="OverflowException">Thrown when the value exceeds what can be stored in the returned type.</exception>
	public static DecodeResult TryRead(ReadOnlySpan<byte> source, out Int64 value, out int tokenSize)
	{
		if (source.Length > 0)
		{
			DecodeResult result = Decoders.Int64JumpTable[source[0]].Read(source, out long longValue, out tokenSize);
	...
	/// <returns>The value.</returns>
	/// <exception cref="OverflowException">Thrown when the value exceeds what can be stored in the returned type.</exception>
	public static unsafe DecodeResult TryRead(ReadOnlySpan<byte> source, out Single value, out int tokenSize)
	{
		tokenSize = 1;
		if (source.Length < 1)
		{
		...
		switch (source[0])
		{
			...
			case >= MessagePackCode.MinNegativeFixInt and <= MessagePackCode.MaxNegativeFixInt:
				DecodeResult result = TryRead(source, out long longValue, out tokenSize);
				value = longValue;
				return result;
	...
	/// <returns>The value.</returns>
	/// <exception cref="OverflowException">Thrown when the value exceeds what can be stored in the returned type.</exception>
	public static unsafe DecodeResult TryRead(ReadOnlySpan<byte> source, out Double value, out int tokenSize)
	{
		tokenSize = 1;
		if (source.Length < 1)
		{
