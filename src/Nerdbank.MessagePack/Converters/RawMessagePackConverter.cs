...
internal class RawMessagePackConverter : MessagePackConverter<RawMessagePack>
{
	...
	/// </remarks>
	public override void Read(ref MessagePackReader reader, ref RawMessagePack value, SerializationContext context) => value = new RawMessagePack(reader.ReadRaw(context)).ToOwned();
