...
public partial record MessagePackSerializer
{
	...
	/// <inheritdoc cref="ConverterCache.RegisterKnownSubTypes{TBase}(KnownDerivedTypeMapping{TBase})"/>
	public void RegisterKnownSubTypes<TBase>(KnownDerivedTypeMapping<TBase> mapping) => this.converterCache.RegisterKnownSubTypes(mapping);
