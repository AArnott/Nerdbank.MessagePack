...
internal record struct SerializableProperty<TDeclaringType>(string Name, ReadOnlyMemory<byte> RawPropertyNameString, SerializeProperty<TDeclaringType> Write, SerializePropertyAsync<TDeclaringType> WriteAsync, Converter Converter, Func<TDeclaringType, bool>? ShouldSerialize, IPropertyShape Shape)
{
	/// <inheritdoc cref="Converter.PreferAsyncSerialization"/>
	internal bool PreferAsyncSerialization => this.Converter.PreferAsyncSerialization;
}
...
/// <param name="Converter">The converter backing this property. Only intended for retrieving the <see cref="PreferAsyncSerialization"/> value.</param>
internal record struct DeserializableProperty<TDeclaringType>(string Name, ReadOnlyMemory<byte> PropertyNameUtf8, DeserializeProperty<TDeclaringType> Read, DeserializePropertyAsync<TDeclaringType> ReadAsync, Converter Converter)
{
	/// <inheritdoc cref="Converter.PreferAsyncSerialization"/>
	internal bool PreferAsyncSerialization => this.Converter.PreferAsyncSerialization;
}
